...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"components/CurrentTimer.tsx":[function(require,module,exports) {
"use strict";
...
function CurrentTimer(props) {
  ...
  }, props.currentTimer), react_1.default.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-around'
    }
  }, react_1.default.createElement("button", {
    onClick: props.toggleCurrentTimer
  }, props.currentTimer === 'Focus' ? "Break" : "Focus")));
}

exports.CurrentTimer = CurrentTimer;
},{"react":"../node_modules/react/index.js"}],"components/Clock.tsx":[function(require,module,exports) {
"use strict";
...
function Clock(props) {
  return react_1.default.createElement("h3", null, props.minutes, ":", props.seconds);
}

exports.Clock = Clock;
},{"react":"../node_modules/react/index.js"}],"components/useInterval.tsx":[function(require,module,exports) {
"use strict";
...
function useInterval(cb, delay) {
  var savedCallback = react_1.default.useRef();
  var timerId = react_1.default.useRef();
...
},{"react":"../node_modules/react/index.js"}],"components/useCountdown.tsx":[function(require,module,exports) {
"use strict";
...
function useCountdown(startingTime) {
  var minutesOrSeconds = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "minutes";

  var _react_1$default$useS = react_1.default.useState(false),
      _react_1$default$useS2 = _slicedToArray(_react_1$default$useS, 2),
      isRunning = _react_1$default$useS2[0],
      setIsRunning = _react_1$default$useS2[1];
  ...
  var _react_1$default$useS3 = react_1.default.useState(function () {
    if (minutesOrSeconds === "minutes") {
      ...
      timeRemaining = _react_1$default$useS4[0],
      setTimeRemaining = _react_1$default$useS4[1];
  ...
  return {
    ...
    toggleRunning: function toggleRunning() {
      setIsRunning(function (i) {
        return !i;
      });
    },
    timeRemaining: {
      totalInSeconds: timeRemaining,
      minutes: "".concat(Math.floor(timeRemaining / 60)).padStart(2, '0'),
      seconds: "".concat(timeRemaining % 60).padStart(2, '0')
    },
...
},{"react":"../node_modules/react/index.js","./useInterval":"components/useInterval.tsx"}],"components/usePomodoro.tsx":[function(require,module,exports) {
"use strict";
...
function usePomodoro() {
  var _react_1$default$useS = react_1.default.useState("Focus"),
      _react_1$default$useS2 = _slicedToArray(_react_1$default$useS, 2),
      currentTimer = _react_1$default$useS2[0],
      setCurrentTimer = _react_1$default$useS2[1];

  var _useCountdown_1$useCo = useCountdown_1.useCountdown(currentTimer === "Focus" ? 25 : 5),
      isRunning = _useCountdown_1$useCo.isRunning,
      toggleRunning = _useCountdown_1$useCo.toggleRunning,
      resetTimer = _useCountdown_1$useCo.resetTimer,
      timeRemaining = _useCountdown_1$useCo.timeRemaining;

  return {
    currentTimer: currentTimer,
    toggleCurrentTimer: function toggleCurrentTimer() {
      resetTimer();
      setCurrentTimer(function (t) {
        return t === "Focus" ? "Break" : "Focus";
      });
    },
    isRunning: isRunning,
...
exports.usePomodoro = usePomodoro;
},{"react":"../node_modules/react/index.js","./useCountdown":"components/useCountdown.tsx"}],"components/Timer.tsx":[function(require,module,exports) {
"use strict";
...
var CurrentTimer_1 = require("./CurrentTimer");

var Clock_1 = require("./Clock");

var usePomodoro_1 = require("./usePomodoro");

function Timer() {
  var _usePomodoro_1$usePom = usePomodoro_1.usePomodoro(),
      currentTimer = _usePomodoro_1$usePom.currentTimer,
      toggleCurrentTimer = _usePomodoro_1$usePom.toggleCurrentTimer,
      isRunning = _usePomodoro_1$usePom.isRunning,
      toggleRunning = _usePomodoro_1$usePom.toggleRunning,
      resetTimer = _usePomodoro_1$usePom.resetTimer,
      timeRemaining = _usePomodoro_1$usePom.timeRemaining;

  return react_1.default.createElement("div", null, react_1.default.createElement(CurrentTimer_1.CurrentTimer, {
    currentTimer: currentTimer,
    toggleCurrentTimer: toggleCurrentTimer
  }), react_1.default.createElement("h2", null, "Time Remaining:"), react_1.default.createElement(Clock_1.Clock, {
    minutes: timeRemaining.minutes,
    seconds: timeRemaining.seconds
  }), react_1.default.createElement("button", {
    onClick: toggleRunning
  }, isRunning ? "Stop" : "Start"), react_1.default.createElement("button", {
    onClick: resetTimer
  }, "Reset"));
}

exports.default = Timer;
},{"react":"../node_modules/react/index.js","./CurrentTimer":"components/CurrentTimer.tsx","./Clock":"components/Clock.tsx","./usePomodoro":"components/usePomodoro.tsx"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
react_dom_1.render(react_1.default.createElement(Timer_1.default, null), document.getElementById('app'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/Timer":"components/Timer.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
